...
import checkersDetector.checkersAIWrapper as ai
from checkersDetector.PythonCheckersAI.minimax.algorithm import minimaxForWhite, minimaxForRed
from checkersDetector.PythonCheckersAI.checkers.constants import RED, WHITE
